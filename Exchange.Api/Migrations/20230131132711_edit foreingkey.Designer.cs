...
namespace Exchange.Api.Migrations
{
    ...
    [Migration("20230131132711_edit foreingkey")]
    partial class editforeingkey
    {
            ...
            modelBuilder.Entity("Exchange.Api.Models.Entities.Coin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2023, 1, 31, 16, 27, 10, 202, DateTimeKind.Local).AddTicks(1790),
                            IsActive = true,
                            Name = "Bitcoin",
                            Price = 500000m,
                            ShortName = "btc"
            ...
            modelBuilder.Entity("Exchange.Api.Models.Entities.NotificationTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 1, 31, 16, 27, 10, 202, DateTimeKind.Local).AddTicks(6320),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 1, 31, 16, 27, 10, 202, DateTimeKind.Local).AddTicks(6390),
                            Description = "Talimat işlemi tamamlanınca gönderilir",
                            IsActive = true,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 1, 31, 16, 27, 10, 202, DateTimeKind.Local).AddTicks(6410),
                            Description = "Talimat işlemi tamamlanınca gönderilir",
                            IsActive = true,
            ...
            modelBuilder.Entity("Exchange.Api.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2023, 1, 31, 16, 27, 10, 202, DateTimeKind.Local).AddTicks(5620),
