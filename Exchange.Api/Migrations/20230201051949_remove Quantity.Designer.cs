...
namespace Exchange.Api.Migrations
{
    ...
    [Migration("20230201051949_remove Quantity")]
            ...
            modelBuilder.Entity("Exchange.Api.Models.Entities.Coin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2023, 2, 1, 8, 19, 49, 204, DateTimeKind.Local).AddTicks(7120),
                            IsActive = true,
                            Name = "Bitcoin",
                            Price = 500000m,
                            ShortName = "btc"
            ...
            modelBuilder.Entity("Exchange.Api.Models.Entities.NotificationTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 2, 1, 8, 19, 49, 205, DateTimeKind.Local).AddTicks(1710),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 2, 1, 8, 19, 49, 205, DateTimeKind.Local).AddTicks(1780),
                            Description = "Talimat işlemi tamamlanınca gönderilir",
                            IsActive = true,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 2, 1, 8, 19, 49, 205, DateTimeKind.Local).AddTicks(1800),
                            Description = "Talimat işlemi tamamlanınca gönderilir",
                            IsActive = true,
            ...
            modelBuilder.Entity("Exchange.Api.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2023, 2, 1, 8, 19, 49, 205, DateTimeKind.Local).AddTicks(930),
