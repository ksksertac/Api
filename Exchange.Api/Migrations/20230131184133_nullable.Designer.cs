...
namespace Exchange.Api.Migrations
{
    ...
    [Migration("20230131184133_nullable")]
            ...
            modelBuilder.Entity("Exchange.Api.Models.Entities.Coin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2023, 1, 31, 21, 41, 32, 793, DateTimeKind.Local).AddTicks(1560),
                            IsActive = true,
                            Name = "Bitcoin",
                            Price = 500000m,
                            ShortName = "btc"
            ...
            modelBuilder.Entity("Exchange.Api.Models.Entities.NotificationTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 1, 31, 21, 41, 32, 793, DateTimeKind.Local).AddTicks(5300),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 1, 31, 21, 41, 32, 793, DateTimeKind.Local).AddTicks(5370),
                            Description = "Talimat işlemi tamamlanınca gönderilir",
                            IsActive = true,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 1, 31, 21, 41, 32, 793, DateTimeKind.Local).AddTicks(5390),
                            Description = "Talimat işlemi tamamlanınca gönderilir",
                            IsActive = true,
            ...
            modelBuilder.Entity("Exchange.Api.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2023, 1, 31, 21, 41, 32, 793, DateTimeKind.Local).AddTicks(4670),
